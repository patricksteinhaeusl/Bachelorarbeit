...
appControllers.controller('ShopCategoryController', ['$rootScope', '$scope', '$routeParams', 'AuthService', 'ShopService', 'AlertsService', function ($rootScope, $scope, $routeParams, AuthService, ShopService, AlertsService) {
    var self = this;
    self.products = {};
