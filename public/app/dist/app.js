...
var routes = {
    ...
    '/profiles/:accountId': {
        templateUrl: function templateUrl(params) {
            var templateUrl = 'assets/profiles/' + params.accountId + '.html';
            var templateNotFound = 'assets/profiles/notFound.html';
...
var appInterceptors = angular.module('app.interceptors', []);
var appControllers = angular.module('app.controllers', []);
var appServices = angular.module('app.services', []);
var appDirectives = angular.module('app.directives', []);
var appFilters = angular.module('app.filters', []);

angular.module('app', ['ngRoute', 'ngCookies', 'ngSanitize', 'LocalStorageModule', 'ngFileUpload', 'angular-toArrayFilter', 'jkAngularRatingStars', 'app.interceptors', 'app.controllers', 'app.services', 'app.directives', 'app.filters', 'angular-clipboard']).config(['$httpProvider', '$locationProvider', '$routeProvider', '$compileProvider', 'localStorageServiceProvider', function ($httpProvider, $locationProvider, $routeProvider, $compileProvider, localStorageServiceProvider) {
    ...
    localStorageServiceProvider.setPrefix('').setStorageType('localStorage');
